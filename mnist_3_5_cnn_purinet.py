...
#Create the training set for 3 and 5 digits
#Get indices of digits 3 and 5
digit_indices = [i for i in range(len(y_train)) if y_train[i] == 3 or y_train[i] == 5]

#Vector of 3 and 5 digits
y_train = np.array([y_train[i] for i in digit_indices])

#Label the digit 3 as 0 and the digit 5 as 1
...
#Training input for 3 and 5 digits
...
#Create the Testing Set for 3 and 5 digits
digit_indices = [i for i in range(len(y_test)) if y_test[i] == 3 or y_test[i] == 5]
