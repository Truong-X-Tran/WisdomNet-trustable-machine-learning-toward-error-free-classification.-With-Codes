...
#Create the training set for 6 and 9 digits
#Get indices of digits 6 and 9
digit_indices = [i for i in range(len(y_train)) if y_train[i] == 6 or y_train[i] == 9]

#Vector of 6 and 9 digits
y_train = np.array([y_train[i] for i in digit_indices])

#Label the digit 6 as 0 and the digit 9 as 1
...
#Training input for 6 and 9 digits
...
#Create the Testing Set for 6 and 9 digits
digit_indices = [i for i in range(len(y_test)) if y_test[i] == 6 or y_test[i] == 9]
