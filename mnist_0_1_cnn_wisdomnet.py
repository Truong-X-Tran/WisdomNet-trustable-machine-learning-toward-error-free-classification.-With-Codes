...
#Create the training set for 0 and 1 digits
#Get indices of digits 0 and 1
digit_indices = [i for i in range(len(y_train)) if y_train[i] == 0 or y_train[i] ==1]

#Vector of 0 and 1 digits
...
#Training input for 0 and 1 digits
...
#Create the Testing Set for 0 and 1 digits
digit_indices = [i for i in range(len(y_test)) if y_test[i] == 0 or y_test[i] ==1]
print(len(digit_indices))

y_test = np.array([y_test[i] for i in digit_indices])

#Label the digit 0 as 0 and the digit 1 as 1
