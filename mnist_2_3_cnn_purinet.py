...
#Create the training set for 2 and 3 digits
#Get indices of digits 2 and 3
digit_indices = [i for i in range(len(y_train)) if y_train[i] == 2 or y_train[i] == 3]

#Vector of 2 and 3 digits
y_train = np.array([y_train[i] for i in digit_indices])

#Label the digit 2 as 0 and the digit 3 as 1
...
#Training input for 2 and 3 digits
...
#Create the Testing Set for 2 and 3 digits
digit_indices = [i for i in range(len(y_test)) if y_test[i] == 2 or y_test[i] == 3]
