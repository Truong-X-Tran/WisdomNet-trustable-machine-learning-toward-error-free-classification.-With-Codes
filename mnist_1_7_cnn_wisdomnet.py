...
#Create the training set for 1 and 7 digits
#Get indices of digits 1 and 7
digit_indices = [i for i in range(len(y_train)) if y_train[i] == 1 or y_train[i] == 7]

#Vector of 1 and 7 digits
y_train = np.array([y_train[i] for i in digit_indices])

#Label the digit 1 as 0 and the digit 7 as 1
...
#Training input for 1 and 7 digits
...
#Create the Testing Set for 1 and 7 digits
digit_indices = [i for i in range(len(y_test)) if y_test[i] == 1 or y_test[i] == 7]
