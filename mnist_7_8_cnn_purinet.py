...
#Create the training set for 7 and 8 digits
#Get indices of digits 7 and 8
digit_indices = [i for i in range(len(y_train)) if y_train[i] == 7 or y_train[i] == 8]

#Vector of 7 and 8 digits
y_train = np.array([y_train[i] for i in digit_indices])

#Label the digit 7 as 0 and the digit 8 as 1
...
#Training input for 7 and 8 digits
...
#Create the Testing Set for 7 and 8 digits
digit_indices = [i for i in range(len(y_test)) if y_test[i] == 7 or y_test[i] == 8]
